...
export class LacampesinaService {
  ...
  createObject(url: String, obj: any): Observable<any> {
    return this.http.post<any>(this.laCampesinaEndpoint + url, obj, {headers: this.httpHeaders});
  }

  updateObject(url: String, obj: any): Observable<any> {
    return this.http.put<any>(`${this.laCampesinaEndpoint + url}/${obj.id}`, obj, {headers: this.httpHeaders});
  }

  deleteObject(url: String, id: Number): Observable<any> {
    return this.http.delete<any>(`${this.laCampesinaEndpoint + url}/${id}`, {headers: this.httpHeaders});
  }
